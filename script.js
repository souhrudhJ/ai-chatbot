document.addEventListener("DOMContentLoaded", () => {
    ...
    updateProgress(30, 2000, 1000, () => {
      updateProgress(75, 2000, 500, () => { 
        updateProgress(100, 2000, 0, () => { // Move to 100% in 1s, no pause
          setTimeout(() => {
            window.location.href = "samanthaChat.html"; // Redirect to chat page
          }, 500); // Brief pause before redirection
        });
      });
    });
  });
  document.addEventListener("DOMContentLoaded", () => {
    ...
    }, 1250); // Change message every second
  });
